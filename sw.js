const CACHE='amanda-clinica-v1.10.5-money-cloud-tabs';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  "./css/borion-hub.css?v=1.10.5",
  "./css/120-money-cloud-tabs.css?v=1.10.5",
  ...
  "./css/110-mobile-borion.css?v=1.10.5",
  "./js/data/initial-data.js",
  "./js/borion-hub.js?v=1.10.5",
  "./js/services/storage.js",
  "./js/services/google-drive.js?v=1.10.5",
  ...
  "./js/services/borion-interop-source.js?v=1.10.5",
  "./js/core/04-actions.js",
  "./js/core/05-events-boot.js?v=1.10.5",
  "./js/core/09-mobile-experience.js?v=1.10.5",
  "./initial-data.json",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
