const CACHE='amanda-clinica-v1.10.3-mobile-borion';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  "./css/borion-hub.css?v=1.10.3",
  ...
  "./css/110-mobile-borion.css?v=1.10.3",
  "./js/data/initial-data.js",
  "./js/borion-hub.js?v=1.10.3",
  "./js/services/storage.js",
  "./js/services/google-drive.js?v=1.10.3",
  ...
  "./js/services/borion-interop-source.js?v=1.10.3",
  "./js/core/04-actions.js",
  "./js/core/05-events-boot.js?v=1.10.3",
  "./js/core/09-mobile-experience.js?v=1.10.3",
  "./initial-data.json",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
