const CACHE='amanda-clinica-v1.22.3-secure-fast-sync';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/190-connection-lifecycle.css?v=1.20.0",
  "./css/200-photo-upload-progress.css?v=1.22.3",
  ...
  "./js/services/secure-json-vault.js?v=1.22.3",
  "./js/services/storage.js?v=1.22.3",
  "./js/services/google-drive.js?v=1.22.3",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.22.3",
  "./js/core/08-integrity-relations.js?v=1.22.3",
  "./js/core/02-ui-components.js?v=1.18.0",
  "./js/core/03-shell-navigation.js?v=1.19.1",
  "./js/core/07-login-signature.js?v=1.19.1",
  "./js/core/10-connection-lifecycle.js?v=1.22.3",
  ...
  "./js/forms/02-records-media.js?v=1.22.3",
  "./js/forms/03-products-profile.js?v=1.18.0",
  "./js/forms/04-disposables-pricing.js?v=1.18.0",
  "./js/services/sync-backup.js?v=1.20.1",
  "./js/services/borion-interop-source.js?v=1.22.3",
  "./js/core/04-actions.js?v=1.22.3",
  "./js/core/05-events-boot.js?v=1.20.0",
