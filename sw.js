const CACHE='amanda-clinica-v1.21.0-live-sync';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/200-photo-upload-progress.css?v=1.21.0",
  ...
  "./js/services/google-drive.js?v=1.21.0",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.21.0",
  ...
  "./js/core/10-connection-lifecycle.js?v=1.21.0",
  ...
  "./js/forms/02-records-media.js?v=1.21.0",
  ...
  "./js/core/04-actions.js?v=1.21.0",
