const CACHE='amanda-clinica-v1.17.0-descartaveis-historico-precos';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./js/borion-hub.js?v=1.10.6",
  "./js/services/storage.js",
  "./js/services/google-drive.js?v=1.10.6",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.17.0",
  "./js/core/08-integrity-relations.js?v=1.17.0",
  "./js/core/02-ui-components.js",
  "./js/core/03-shell-navigation.js?v=1.17.0",
  ...
  "./js/core/06-fast-ui.js?v=1.17.0",
  "./js/forms/00-appointments-clients.js?v=1.17.0",
  "./js/forms/01-packages-attendance.js?v=1.17.0",
  "./js/forms/02-records-media.js",
  "./js/forms/03-products-profile.js?v=1.17.0",
  "./js/forms/04-disposables-pricing.js?v=1.17.0",
  "./js/services/sync-backup.js",
  "./js/services/borion-interop-source.js?v=1.10.6",
  "./js/core/04-actions.js?v=1.17.0",
  "./js/core/05-events-boot.js?v=1.17.0",
  "./js/core/09-mobile-experience.js?v=1.10.6",
  "./initial-data.json",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
