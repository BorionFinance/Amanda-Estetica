const CACHE='amanda-clinica-v1.22.4-secure-fast-sync';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/200-photo-upload-progress.css?v=1.22.4",
  ...
  "./js/services/secure-json-vault.js?v=1.22.4",
  "./js/services/storage.js?v=1.22.4",
  "./js/services/google-drive.js?v=1.22.4",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.22.4",
  "./js/core/08-integrity-relations.js?v=1.22.4",
  "./js/core/02-ui-components.js?v=1.18.0",
  "./js/core/03-shell-navigation.js?v=1.19.1",
  "./js/core/07-login-signature.js?v=1.19.1",
  "./js/core/10-connection-lifecycle.js?v=1.22.4",
