const CACHE='amanda-clinica-v1.22.0-secure-fast-sync';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/200-photo-upload-progress.css?v=1.22.0",
