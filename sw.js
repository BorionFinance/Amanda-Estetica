const CACHE='amanda-clinica-v1.19.0-performance-fluid';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/180-performance-fluid.css?v=1.19.0",
  ...
  "./js/borion-hub.js?v=1.19.0",
  "./js/services/storage.js?v=1.19.0",
  "./js/services/google-drive.js?v=1.16.0",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.19.0",
  "./js/core/08-integrity-relations.js?v=1.18.0",
  "./js/core/02-ui-components.js?v=1.18.0",
  "./js/core/03-shell-navigation.js?v=1.19.0",
  "./js/core/07-login-signature.js?v=1.19.0",
  ...
  "./js/core/06-fast-ui.js?v=1.19.0",
  ...
  "./js/core/05-events-boot.js?v=1.19.0",
  "./js/core/09-mobile-experience.js?v=1.19.0",
  "./initial-data.json",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
