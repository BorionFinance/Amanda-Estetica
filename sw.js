const CACHE='amanda-clinica-v1.20.0-data-protection';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./js/services/google-drive.js?v=1.20.0",
  "./js/core/00-config-icons.js?v=1.17.0",
  "./js/core/01-state-utils.js?v=1.20.0",
  ...
  "./js/core/10-connection-lifecycle.js?v=1.20.0",
  ...
  "./js/services/sync-backup.js?v=1.20.0",
  "./js/services/borion-interop-source.js?v=1.15.2",
  "./js/core/04-actions.js?v=1.20.0",
