const CACHE='amanda-clinica-v1.18.0-configuracoes-organizadas';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./js/core/05-events-boot.js?v=1.18.0",
