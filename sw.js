const CACHE='amanda-clinica-v1.10.2-mobile-borion';
const APP_SHELL=[
  "./",
  "./index.html",
  "./css/00-base.css",
  ...
  "./css/110-mobile-borion.css?v=1.10.2",
  "./js/data/initial-data.js",
  "./js/services/storage.js",
  "./js/services/google-drive.js?v=1.10.2",
  ...
  "./js/services/borion-interop-source.js?v=1.10.2",
  "./js/core/04-actions.js",
  "./js/core/05-events-boot.js?v=1.10.2",
  "./js/core/09-mobile-experience.js?v=1.10.2",
  "./initial-data.json",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
