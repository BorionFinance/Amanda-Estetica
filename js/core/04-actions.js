...
async function handleAction(action, el) {
    ...
    const map={
      ...
      'create-local-backup':async()=>{await ClinicStorage.createLocalBackup(STATE,'manual');toast('Backup criptografado criado no Google Drive.');},
